                ...
                <div className="grid grid-cols-2 gap-3">
                  {['bike', 'scooter'].map(t => (
                    <button
                      ...
                      className={`py-3 rounded-2xl border-2 font-bold text-sm capitalize transition-all ${regData.vehicleType === t ? 'border-primary bg-primary/5 text-primary' : 'border-zinc-100 text-zinc-400'
                        }`}
                    >
                      {t}
                    </button>
      ...
      <div className="bg-white px-6 py-8 border-b border-zinc-100 relative overflow-hidden">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-4 bg-zinc-50 p-2 rounded-[2rem] border border-zinc-100 shadow-inner hidden md:flex">
            ...
            <Button
              ...
              className="rounded-full shadow-sm hover:text-destructive hover:border-destructive hover:bg-destructive/5 transition-all w-12 h-12 p-0"
              title="Logout"
            >
              <LogOut className="w-5 h-5 text-zinc-500 hover:text-destructive" />
            </Button>
          </div>
        </div>
      </div>
